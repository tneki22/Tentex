...
/**
 * Связанные страницы-источники для вопроса.
 *
 ...
 * Берём объединение — иначе режим страниц молча пуст на половине вопросов.
 * Важно: сами группы не доказывают наличие активного эталона. Ручные или
 * файловые привязки могут сохраниться, когда слот ответа отсутствует.
 *
