...
export function ProjectWorkspace() {
  ...
  const tracking = useStudyTracking(projectId, selected?.id ?? null, trackingKind, Boolean(selected) && (detail?.project.status === "active" || detail?.project.status === "draft"));
  ...
  return (
    <div className={`project-workspace ${textbook ? "is-textbook" : "is-exam"}`} style={{ "--workspace-tree-width": `${layout.tree_width}px` } as CSSProperties}>
      ...
      <main className="workspace-main">
        ...
        <StudyTimer projectId={projectId} tracking={tracking} />
